...
![](图片/PRIP并行冗余通信协议自测报告/图片2.png) 

图4.1 不合法地址输入的结果

然后，再通过echo命令输入正常合法的IP地址，其显示结果如下图所示：

![](图片/PRIP并行冗余通信协议自测报告/图片3.png) 
...
![](图片/PRIP并行冗余通信协议自测报告/图片4.png) 

图4.3：配置项输入不完整的测试结果

然后，再对配置项输入完整进行测试，测试结果如下图所示：

![](图片/PRIP并行冗余通信协议自测报告/图片5.png) 
...
![img](file:////tmp/wps-rocky/ksohtml/wps5cKlRC.jpg) 
...
![img](file:////tmp/wps-rocky/ksohtml/wpsfLzGgB.jpg) 

图4.30 客户端主链路捕包截图

![img](file:////tmp/wps-rocky/ksohtml/wps3gFt9b.jpg) 

图4.31 客户端从链路捕包截图

此时连接已建立，然后通过netstat命令将连接建立前和连接建立后的系统网路连接的进行对比，如下图所示：

![img](file:////tmp/wps-rocky/ksohtml/wps6KCi2M.jpg) 
...
![img](file:////tmp/wps-rocky/ksohtml/wpswgu9Un.jpg) 
...
![img](file:////tmp/wps-rocky/ksohtml/wpsCOZ1NY.jpg) 
...
![img](file:////tmp/wps-rocky/ksohtml/wpsulnWGz.jpg) 

图4.35 服务端主链路捕包截图

![img](file:////tmp/wps-rocky/ksohtml/wpsv7TSza.jpg) 
...
![img](file:////tmp/wps-rocky/ksohtml/wpsLbKRsL.jpg) 
...
![img](file:////tmp/wps-rocky/ksohtml/wpsQZFSlm.jpg) 
...
![img](file:////tmp/wps-rocky/ksohtml/wpsW59faR.jpg) 

图4.59 客户端主链路网卡捕包截图

![img](file:////tmp/wps-rocky/ksohtml/wpslEzl4r.jpg) 

图4.60 客户端从链路网卡捕包截图

客户端应用程序通信内容的显示如下图所示：

![img](file:////tmp/wps-rocky/ksohtml/wpsk8CsY2.jpg) 

图4.61 客户端应用程序的内容显示

客户端系统PRIP状态显示，如下图所示：

![img](file:////tmp/wps-rocky/ksohtml/wpss5eBSD.jpg) 
...
![img](file:////tmp/wps-rocky/ksohtml/wpsLgALMe.jpg) 

图4.63 服务端主链路网卡捕包截图

![img](file:////tmp/wps-rocky/ksohtml/wps6ZIXGP.jpg) 

图4.64 服务端从链路网卡捕包截图

服务端应用程序通信内容显示，如下图所示：

![img](file:////tmp/wps-rocky/ksohtml/wpsHMAbBq.jpg) 

图4.65 服务端应用程序内容显示

服务端系统PRIP状态显示，如下图所示：

![img](file:////tmp/wps-rocky/ksohtml/wpsxX4qv1.jpg) 
